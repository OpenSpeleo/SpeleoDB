...
## Data Privacy, Survey Secrecy, and Responsible Stewardship

Our community operates in environments where discretion, trust, and data
integrity are essential. Cave diving, underwater exploration, and archaeological
documentation involve sensitive geographic, environmental, cultural, and
personal data. The safety of individuals, the protection of heritage sites, and
the integrity of ongoing research depend on responsible data stewardship.

### Our Commitment

We commit to:

1. Protecting **sensitive location data**, survey results, and exploration
   records.
2. Respecting **data access boundaries** and permission models.
3. Safeguarding **personal, scientific, and cultural information** entrusted to
   the platform and community.
4. Acting in ways that preserve the **reputation, safety, and long-term
   mission** of the project.

### Data Access and Confidentiality

Community members, administrators, contributors, and maintainers:

1. Must **not attempt to access, extract, or infer data** they have not been
   expressly granted permission to access.
2. Must not bypass, probe, or test access controls except where explicitly
   authorized as part of a defined security or administrative responsibility.
3. Must not share restricted survey data, coordinates, imagery, or research
   materials without proper authorization with prior authorization of the owner
   of the data.
4. Must handle credentials, private repositories, and internal communications
   with care and discretion.

Actions within community systems may be logged to ensure transparency,
accountability, and the protection of shared resources. These logs are
maintained for security and governance purposes.

### Responsible Representation

Your actions — technical, administrative, or interpersonal — represent this
project and its mission.

Irresponsible handling of data, misuse of access privileges, or actions that
compromise confidentiality can:

- Endanger individuals and exploration teams.
- Damage fragile underwater or archaeological sites.
- Harm the reputation and credibility of the community.
- Undermine trust among contributors, users, partners, and institutions.

Such actions will be treated as serious violations under this Code of Conduct
and may result in immediate escalation with possible permanent exclusion of the
project.

### Stewardship of Open Source Contributions

This software exists because of the good will, expertise, and volunteer effort
of open source contributors.

We therefore expect community members to:

1. Respect the time and labor of contributors.
2. Avoid actions that could expose the project to legal, ethical, or
   reputational risk.
3. Engage responsibly when reporting vulnerabilities or handling
   security-sensitive information.
4. Act in ways that sustain long-term trust in the project and its governance.

Trust is foundational to both safe exploration and successful open source
collaboration. Protecting data, respecting boundaries, and acting with integrity
are not optional — they are core to our mission.
...
possible violation, contact the Board of Director of Underwater Speleological
and Archaeological Heritage Institute at <bod@usahinstitute.org> or
`alberto/jonathan/gavin/giana @ usahinstitute.org`.
