...
@pytest.fixture
def member_membership(db, team: SurveyTeam) -> SurveyTeamMembership:
    """
...
class TestSurveyTeam:
    def test_str_representation(self, team: SurveyTeam):
    ...
    def test_is_leader_false(self, team, member_membership):
...
class TestSurveyTeamMembership:
    def test_str_representation_leader(self, leader_membership):
        """Test the __str__ method."""
        assert (
    ...
    def test_role_property_setter(self, member_membership):
    ...
    def test_deactivate(self, member_membership: SurveyTeamMembership, user: User):
    ...
    def test_reactivate(self, member_membership, user: User):
    ...
    def test_inactive_membership_not_included(
        self, team: SurveyTeam, user: User, member_membership
    ):
