...
class ProcessingErrorCode(StrEnum):
    ...
    KML_FEATURE_LIMIT = "KML_FEATURE_LIMIT"
    KML_COORDINATE_LIMIT = "KML_COORDINATE_LIMIT"
    GEOJSON_TOO_LARGE = "GEOJSON_TOO_LARGE"
    KML_NO_RENDERABLE_GEOMETRY = "KML_NO_RENDERABLE_GEOMETRY"
