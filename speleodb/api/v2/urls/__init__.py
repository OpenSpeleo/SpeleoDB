...
from speleodb.api.v2.urls.cylinder import urlpatterns as cylinder_urlpatterns
from speleodb.api.v2.urls.cylinder_fleet import (
    urlpatterns as cylinder_fleet_urlpatterns,
)
from speleodb.api.v2.urls.cylinder_install import (
    urlpatterns as cylinder_install_urlpatterns,
)
from speleodb.api.v2.urls.experiment import urlpatterns as experiment_urlpatterns
from speleodb.api.v2.urls.experiment_records import (
    urlpatterns as experiment_record_urlpatterns,
)
from speleodb.api.v2.urls.exploration_lead import (
...
from speleodb.api.v2.urls.sensor import urlpatterns as sensor_urlpatterns
from speleodb.api.v2.urls.sensor_fleet import urlpatterns as sensor_fleet_urlpatterns
from speleodb.api.v2.urls.station import urlpatterns as station_urlpatterns
from speleodb.api.v2.urls.station_tag import urlpatterns as station_tag_urlpatterns
from speleodb.api.v2.urls.surface_network import (
    urlpatterns as surface_network_urlpatterns,
)
from speleodb.api.v2.urls.team import urlpatterns as team_urlpatterns
from speleodb.api.v2.urls.tools import urlpatterns as tool_urlpatterns
from speleodb.api.v2.urls.user import urlpatterns as user_urlpatterns
from speleodb.api.v2.views.announcement import PublicAnnouncementApiView
from speleodb.api.v2.views.plugin_release import PluginReleasesApiView
