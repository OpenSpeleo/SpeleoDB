...
from speleodb.api.v2.serializers import PluginReleaseSerializer
...
class TestPluginReleasesApiView(BaseAPITestCase):
    ...
    url_name: str = (
        "api:v2:plugin-releases"  # Make sure this name is defined in your urls.py
    )
    ...
    def test_ordering_by_creation_date(self) -> None:
        ...
        actual_dates = [item["creation_date"] for item in response.data]
        ...
        actual_ids = [item["id"] for item in response.data]
