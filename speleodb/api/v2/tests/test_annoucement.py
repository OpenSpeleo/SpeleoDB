...
from speleodb.api.v2.serializers import PublicAnnoucementSerializer
...
class TestPublicAnnouncementApiView(BaseAPITestCase):
    ...
    url_name: str = (
        "api:v2:public-announcements"  # Ensure you have this named in your urls.py
    )
    ...
    def test_get_announcements_ordering(self) -> None:
        ...
        actual_titles = [ann["title"] for ann in response.data]
    ...
    def test_get_all_announcements_with_inactive_filtered_out(self) -> None:
        ...
        assert response.data[0]["title"] == active_announcement.title  # pyright: ignore[reportAttributeAccessIssue]
