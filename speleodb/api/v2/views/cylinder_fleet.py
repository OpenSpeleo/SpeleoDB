...
from speleodb.api.v2.serializers import CylinderFleetSerializer
from speleodb.api.v2.serializers import CylinderFleetUserPermissionSerializer
from speleodb.api.v2.serializers import CylinderFleetWithPermSerializer
from speleodb.api.v2.serializers import CylinderInstallGeoJSONSerializer
from speleodb.api.v2.serializers import CylinderInstallSerializer
from speleodb.api.v2.serializers import CylinderPressureCheckSerializer
from speleodb.api.v2.serializers import CylinderSerializer
...
class CylinderFleetApiView(GenericAPIView[CylinderFleet], SDBAPIViewMixin):
    ...
    @extend_schema(operation_id="v2_cylinder_fleets_list")
...
class CylinderInstallApiView(GenericAPIView[CylinderInstall], SDBAPIViewMixin):
    ...
    @extend_schema(operation_id="v2_cylinder_installs_list")
    def get(self, request: Request, *args: Any, **kwargs: Any) -> Response:
        """
...
class CylinderPressureCheckApiView(
    ...
    @extend_schema(operation_id="v2_cylinder_installs_pressure_checks_list")
    def get(
