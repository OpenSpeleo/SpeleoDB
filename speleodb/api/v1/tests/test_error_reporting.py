...
class ProjectExplorerSentryTests(BaseAPIProjectTestCase):
    ...
    @patch(
        "speleodb.api.v1.views.project_explorer.sentry_sdk.capture_exception",
        autospec=True,
    )
...
class ProjectDetailSentryTests(BaseAPIProjectTestCase):
    ...
    @patch(
        "speleodb.api.v1.views.project.sentry_sdk.capture_exception",
        autospec=True,
    )
    def test_project_detail_gitlab_error_returns_500_with_sentry(
        ...
        with patch(
            "speleodb.api.v1.serializers.project.ProjectSerializer.to_representation",
            side_effect=GitlabError("simulated gitlab outage"),
        ):
            response = self.client.get(
                reverse(
...
class GPXImportSentryTests(BaseAPIProjectTestCase):
    ...
    @patch(
        "speleodb.api.v1.views.gpx_import.sentry_sdk.capture_exception",
        autospec=True,
    )
...
class KMLImportSentryTests(BaseAPIProjectTestCase):
    ...
    @patch(
        "speleodb.api.v1.views.kml_kmz_import.sentry_sdk.capture_exception",
        autospec=True,
    )
...
class GISViewSentryTests(TestCase):
    ...
    @patch(
        "speleodb.api.v1.views.gis_view.sentry_sdk.capture_exception",
        autospec=True,
    )
    def test_gis_view_data_error_returns_500_with_sentry(
        ...
        with patch(
            "speleodb.api.v1.views.gis_view.GISViewDataSerializer",
...
class ToolsDMPSentryTests(TestCase):
    ...
    @patch(
        "speleodb.api.v1.views.tools.sentry_sdk.capture_exception",
        autospec=True,
    )
    def test_dmp_parse_error_returns_500_with_sentry(
        ...
        with patch(
            "speleodb.api.v1.views.tools.DMPFile.from_dmp",
