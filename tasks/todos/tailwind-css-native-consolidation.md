...
- [x] Add dark-scheme metadata and CSS declarations to every owned root
      document.
- [x] Strengthen compiler, source-isolation, token, plugin, and script
      contracts.
...
- [x] Prove structural, computed-style, and pixel parity against the frozen
      baseline.
