...
- [x] Remove exact dependency and lockfile-format versions from the Tailwind contract.
...
tests), the full JavaScript suite passes (927 tests), and JavaScript lint passes.
