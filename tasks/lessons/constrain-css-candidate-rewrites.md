...
Bulk Tailwind candidate rewrites must operate only on class-bearing files in
the public/private source contract. A broad repository rewrite can silently
touch vendor assets, backend strings, fixtures, or documentation that the
compiler never scans.
